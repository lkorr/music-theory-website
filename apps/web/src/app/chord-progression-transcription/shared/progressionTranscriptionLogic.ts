...
import { noteNames } from "../../chord-recognition/shared/theory/core/notes";
import { chordTypes, seventhChordTypes, extendedChordTypes } from "../../chord-recognition/shared/theory/core/constants";
...
function generateChordFromRomanNumeral(romanNumeral: string, key: string, baseOctave: number = 60): ChordData {
  ...
  const keyRootIndex = noteNames.indexOf(keyRoot);
