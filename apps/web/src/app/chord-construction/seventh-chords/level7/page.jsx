...
// Generate random 7th chord construction task with inversions
const generateConstructionTask = (previousTask = null) => {
  ...
  const inversions = [0, 1]; // Root position and 1st inversion
  ...
  if (inversion > 0) {
    ...
    chordName += `/${bassNote}`;
    description += ` in ${inversion === 1 ? '1st' : '2nd'} inversion`;
  } else {
      ...
      <div className="grid grid-cols-5 gap-4 text-center">
        ...
        <div>
          <div className={`text-2xl font-bold ${
            avgTime > 0 && avgTime <= 15 ? 'text-green-600' : avgTime > 15 ? 'text-red-600' : 'text-white'
          }`}>
...
export default function Level7Construction() {
  ...
  const PASS_TIME = 15; // 15 seconds (longer for inversions)
  ...
  const validateChord = () => {
    ...
    // For Level 7: 7th chords with inversions, so we need exactly 4 notes
          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-bold text-white">
                Level 7: Build First Inversions
              </h1>
            </div>
        ...
        <main className="max-w-6xl mx-auto p-6">
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center min-h-[80vh]">
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-8 lg:w-1/2">
              <h2 className="text-3xl font-bold text-white mb-6">Ready to Start Level 7?</h2>
              <div className="text-lg text-white/80 mb-8 space-y-2">
                <p><strong>{TOTAL_PROBLEMS} problems</strong> to complete</p>
                <p>Build <strong>7th chords</strong> in root position and first inversion</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:w-1/2">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">7th Chord Inversions</h3>
              <div className="space-y-4 text-white/80">
                <div className="bg-white/10 rounded-xl p-4">
                  <h4 className="font-bold mb-2">Instructions</h4>
                  <p className="text-sm">Build 7th chords in root position or first inversion as requested.</p>
                </div>
                
                <div className="bg-white/10 rounded-xl p-4">
                  <h4 className="font-bold mb-2">Inversions</h4>
                  <ul className="text-sm space-y-1">
                    <li>• <strong>Root Position:</strong> Root on bottom (e.g., C-E-G-B)</li>
                    <li>• <strong>First Inversion:</strong> 3rd on bottom (e.g., E-G-B-C)</li>
                  </ul>
                </div>
                
                <div className="bg-white/10 rounded-xl p-4">
                  <h4 className="font-bold mb-2">Example</h4>
                  <p className="text-sm">For "Cmaj7/1" (first inversion): Place E, G, B, and C notes with E as the lowest.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <main className="max-w-2xl mx-auto p-6 flex items-center justify-center min-h-[80vh]">
          <div className={`text-center backdrop-blur-sm rounded-2xl p-8 ${
            ...
            <div className="flex gap-4 justify-center">
              ...
              {levelResult.passed && (
                <Link
                  to="/chord-construction/seventh-chords/level8"
      ...
      <header className="bg-black/20 backdrop-blur-md border-b border-white/10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-bold text-white">
              Level 7: Build First Inversions - Problem {score.total}/{TOTAL_PROBLEMS}
            </h1>
          </div>
              ...
              <div className="space-y-4">
                ...
                {feedback && (
                  <div className={`p-4 rounded-lg ${
                    ...
                    {feedback.isCorrect && (
                      <p className="mt-2">Excellent 7th chord inversion construction!</p>
                    )}
                  </div>
                )}
              </div>
          ...
          <div className="xl:w-80">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <h4 className="font-semibold text-white mb-2">7th Inversions:</h4>
                <div className="text-sm text-white/70 space-y-1">
                  <p>• <strong>Root:</strong> Cmaj7, Dm7</p>
                  <p>• <strong>1st Inv:</strong> Cmaj7/1, Dm7/1</p>
                  <p>• <strong>Slash:</strong> Cmaj7/E, Dm7/F</p>
                </div>
              </div>
