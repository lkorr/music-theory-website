      ...
      <div className="grid grid-cols-5 gap-4 text-center">
        ...
        <div>
          <div className={`text-2xl font-bold ${
            avgTime > 0 && avgTime <= 18 ? 'text-green-600' : avgTime > 18 ? 'text-red-600' : 'text-white'
          }`}>
        ...
        <main className="max-w-6xl mx-auto p-6">
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center min-h-[80vh]">
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-8 lg:w-1/2">
              <h2 className="text-3xl font-bold text-white mb-6">Ready to Start Level 8?</h2>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:w-1/2">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">All 7th Chord Inversions</h3>
      ...
      <header className="bg-black/20 backdrop-blur-md border-b border-white/10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-bold text-white">
              Level 8: Build All Inversions - Problem {score.total}/{TOTAL_PROBLEMS}
            </h1>
          </div>
              ...
              <div className="space-y-4">
                ...
                {feedback && (
                  <div className={`p-4 rounded-lg ${
                    ...
                    {feedback.isCorrect && (
                      <p className="mt-2">Excellent 7th chord inversion mastery!</p>
                    )}
                  </div>
                )}
              </div>
          ...
          <div className="xl:w-80">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <h4 className="font-semibold text-white mb-2">All 7th Inversions:</h4>
                <div className="text-sm text-white/70 space-y-1">
                  <p>• <strong>Root:</strong> Cmaj7, Dm7</p>
                  <p>• <strong>1st:</strong> Cmaj7/1, Dm7/1</p>
                  <p>• <strong>2nd:</strong> Cmaj7/2, Dm7/2</p>
                  <p>• <strong>3rd:</strong> Cmaj7/3, Dm7/3</p>
                  <p>• <strong>Slash:</strong> Cmaj7/E, Cmaj7/G</p>
                </div>
              </div>
