...
import UniversalChordConstructor from "../../shared/UniversalChordConstructor";
 ...
 */
function LevelNotFoundError({ category, level }: ErrorComponentProps) {
  return (
 ...
 */
function ConfigurationError({ category, level }: ErrorComponentProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] flex items-center justify-center">
      {/* Logo in absolute top-left corner */}
      <Link to="/" className="absolute top-2 left-2 z-50">
 ...
 */
export default function ChordConstructionLevelPage(): JSX.Element {
