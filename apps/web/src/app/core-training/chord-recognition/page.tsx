...
export default function ChordRecognition2Page(): React.ReactNode {
  const recognitionCategories: RecognitionCategory[] = [
    {
      id: 'basic-triads',
      title: 'Basic Triads',
      ...
      levels: [
        {
          ...
          path: '/core-training/chord-recognition/seventh-chords/1'
        },
        {
          id: 'level2',
          title: 'Level 2: First Inversions',
          description: '7th chords with first inversion',
          path: '/core-training/chord-recognition/seventh-chords/2'
        },
        {
          id: 'level3',
          title: 'Level 3: Second Inversions',
          description: '7th chords with second inversion',
          path: '/core-training/chord-recognition/seventh-chords/3'
        },
        {
          id: 'level4',
          title: 'Level 4: Third Inversions',
          description: '7th chords with third inversion',
          path: '/core-training/chord-recognition/seventh-chords/4'
        },
        {
          id: 'level5',
          title: 'Level 5: Open Voicings',
          description: '7th chords with open voicings',
          path: '/core-training/chord-recognition/seventh-chords/5'
        }
      ]
    },
    {
      ...
      <main className="max-w-7xl mx-auto p-6">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center space-x-4">
            <Link
              to="/leaderboard?module=core-training/chord-recognition"
            ...
            >
              🏆 View Chord Recognition Leaderboard
            </Link>
          </div>
        </div>
