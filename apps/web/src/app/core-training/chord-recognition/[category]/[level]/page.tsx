 ...
 * 
 * Route Pattern: /core-training/chord-recognition/[category]/[level]
 * Examples:
 * - /core-training/chord-recognition/basic-triads/1
 * - /core-training/chord-recognition/seventh-chords/3
 * - /core-training/chord-recognition/extended-chords/6
 * 
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] flex items-center justify-center">
      <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center max-w-md">
        ...
        <div className="space-y-3">
          <Link
            to="/core-training/chord-recognition"
