/**
 * Chord Progressions Level 4: Non-Diatonic Chords with Inversions
 * 
 * Based on Level 3 but with required inversion labeling
 */
...
import { generateLevel4Progression, validateLevel4Answer } from "./level4Utils.js";
...
export default function ChordProgressionsLevel4(): JSX.Element {
  // Get level configuration
  const config: LevelConfig = getLevelConfig('progressionLevel4');
  ...
  const logic = useLevelLogic(state, config, {
    generateChord: generateLevel4Progression,
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] relative">
        ...
        <main className="max-w-6xl mx-auto p-6">
          <div className="flex flex-col lg:flex-row gap-8 items-start justify-center min-h-[80vh]">
            ...
            {/* Non-Diatonic with Inversions Examples - Musical blurb */}
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:w-1/2">
              <h3 className="text-2xl font-bold text-white mb-6 text-center">Non-Diatonic Chords with Inversions</h3>
              <div className="space-y-4 text-white/80">
                <div className="bg-white/10 rounded-xl p-4">
                  ...
                  <p className="text-sm mt-1 text-white/60">With inversions: bII6, bVI64, etc.</p>
                </div>
                <div className="bg-white/10 rounded-xl p-4">
                  <h4 className="font-bold text-white mb-2">Neapolitan Sixth</h4>
                  <p className="text-sm">N6 or bII6 - A first inversion bII chord</p>
                  <p className="text-sm mt-1 text-white/60">Often appears in first inversion</p>
                </div>
                <div className="bg-white/10 rounded-xl p-4">
                  <h4 className="font-bold text-white mb-2">Augmented Chords</h4>
                  <p className="text-sm">I+, V+ - Augmented triads can be inverted</p>
                  <p className="text-sm mt-1 text-white/60">Example: I+6, V+64</p>
                </div>
                <div className="bg-white/10 rounded-xl p-4">
                  <h4 className="font-bold text-white mb-2">Format with Inversions</h4>
                  <p className="text-sm">
                    Use figured bass notation for inversions<br/>
                    Example: I6 - N6 - V64 - I
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <input
                  ...
                  placeholder="Enter roman numerals with inversions (e.g., I6 - N6 - V64 - I)"
          ...
          <div className="xl:w-80">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              ...
              <div className="mt-6 pt-6 border-t border-white/10">
                <h4 className="font-semibold text-white mb-2">Non-Diatonic with Inversions:</h4>
                <div className="text-sm text-white/70 space-y-1">
                  <p><strong>Borrowed chords:</strong></p>
                  <p>bII, bIII, bVI, bVII</p>
                  <p><strong>With inversions:</strong></p>
                  <p>bII6, bVI64, etc.</p>
                  <p><strong>Neapolitan:</strong></p>
                  <p>N6 (same as bII6)</p>
                  <p><strong>Format:</strong> Include inversions</p>
                  <p>Example: I6 - N6 - V64 - I</p>
                </div>
              </div>
            </div>
          </div>
