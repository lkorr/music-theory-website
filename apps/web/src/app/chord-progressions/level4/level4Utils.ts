...
import { generateProgression, validateProgressionAnswer, keySignatures, romanNumerals } from '../shared/progressionLogic';
...
const level4Progressions: ChordInfo[][] = [
 ...
 */
export const generateLevel4Progression = (): ChordProgression => {
 ...
 */
export const validateLevel4Answer = (userAnswer: string, expectedAnswer: string): boolean => {
