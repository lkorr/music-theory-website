...
export const LEVEL_CONFIGS = {
  ...
  'basic-triads-1': {
    ...
    // Navigation
    nextLevelPath: '/chord-construction2/basic-triads/2',
    backPath: '/chord-construction2'
  },
  ...
  'basic-triads-2': {
    ...
    nextLevelPath: '/chord-construction2/basic-triads/3',
    backPath: '/chord-construction2'
  },
  ...
  'basic-triads-3': {
    ...
    nextLevelPath: '/chord-construction2/seventh-chords/1',
    backPath: '/chord-construction2'
  },
  ...
  'seventh-chords-1': {
    ...
    nextLevelPath: '/chord-construction2/seventh-chords/2',
    backPath: '/chord-construction2'
  },
  ...
  'seventh-chords-2': {
    ...
    nextLevelPath: '/chord-construction2/seventh-chords/3',
    backPath: '/chord-construction2'
  },
  ...
  'seventh-chords-3': {
    ...
    nextLevelPath: '/chord-construction2/extended-chords/1',
    backPath: '/chord-construction2'
  },
  ...
  'extended-chords-1': {
    ...
    nextLevelPath: '/chord-construction2/extended-chords/2',
    backPath: '/chord-construction2'
  },
  ...
  'extended-chords-2': {
    ...
    nextLevelPath: '/chord-construction2/extended-chords/3',
    backPath: '/chord-construction2'
  },
 ...
 * @param {string} category - The category from URL (basic-triads, seventh-chords, extended-chords)
 * @param {string} level - The level number from URL (1, 2, 3)
 * @returns {object|null} Level configuration object or null if not found
 */
export function getLevelConfigByParams(category, level) {
 ...
 * @returns {Array} Array of level configurations
 */
 ...
 * @returns {object|null} Next level configuration or null if no next level
 */
export function getNextLevel(currentCategory, currentLevel) {
