...
import { generateLevel3Progression, validateLevel3Answer, level3Config } from "./level3Utils.js";
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] relative">
        ...
        <header className="bg-black/20 backdrop-blur-md border-b border-white/10 px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-4 ml-16">
              ...
              <h1 className="text-xl font-bold text-white">{level3Config.title}</h1>
            </div>
            {/* <CompactAuthButton /> */}
          </div>
        </header>
        ...
        <main className="max-w-6xl mx-auto p-6">
          <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-8 mx-auto max-w-2xl">
            <h2 className="text-3xl font-bold text-white mb-6">Ready to Start {level3Config.title}?</h2>
            <div className="text-lg text-white/70 mb-8 space-y-2">
              <p><strong>{level3Config.totalProblems} problems</strong> to complete</p>
              <p>{level3Config.description}</p>
              <p>Need <strong>{level3Config.passAccuracy}% accuracy</strong> to pass</p>
              <p>Average time must be under <strong>{level3Config.passTime} seconds</strong></p>
            </div>
            <button
              onClick={startLevel}
              className={`px-12 py-4 ${level3Config.buttonColor} text-white text-xl font-bold rounded-xl hover:${level3Config.buttonHoverColor} transition-colors shadow-lg`}
            >
              Start {level3Config.title}
            </button>
          </div>
        </main>
      </div>
