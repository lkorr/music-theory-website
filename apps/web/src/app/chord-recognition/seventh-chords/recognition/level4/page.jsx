        ...
        <header className="bg-white/10 backdrop-blur-md border-b border-white/20 px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Link to="/chord-recognition/seventh-chords" className="w-8 h-8 rounded-full bg-black flex items-center justify-center hover:bg-gray-800 transition-colors">
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] flex items-center justify-center p-6">
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 max-w-md w-full text-center">
          ...
          <div className="space-y-4">
            {levelResult.passed && (
              <Link 
                to="/chord-recognition/seventh-chords/recognition/level5"
        ...
        <div className="flex flex-col xl:flex-row gap-8 items-start">
            ...
            <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <input
                  ...
                  placeholder="Enter 7th chord with all inversions (e.g., Cmaj7, Dm7/1, G7/2, Fdim7/3)"
                  className="w-full px-4 py-3 text-lg rounded-lg border-2 border-black/20 focus:border-orange-600 focus:outline-none bg-white/50"
          ...
          <div className="xl:w-80">
            <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-6">
              <h3 className="text-xl font-bold text-black mb-4">Statistics</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  <span className="text-black/70">Avg Time:</span>
                  <span className="font-semibold text-black">{avgTime.toFixed(1)}s</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="mt-6 pt-6 border-t border-black/10">
                <h4 className="font-semibold text-black mb-2">7th Chord Inversions:</h4>
                <div className="text-sm text-black/70 space-y-1">
                  ...
                  <p>• <strong>2nd inversion:</strong> Cmaj7/2 or Cmaj7/G</p>
                  <p>• <strong>3rd inversion:</strong> Cmaj7/3 or Cmaj7/B</p>
                  <p>• Use numbered or slash notation</p>
                </div>
                
                <h4 className="font-semibold text-black mb-2 mt-4">7th Chord Types:</h4>
                <div className="text-sm text-black/70 space-y-1">
