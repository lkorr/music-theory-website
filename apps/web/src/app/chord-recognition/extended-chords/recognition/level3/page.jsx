/**
 * Extended Chords Level 3: 7th Chords with First and Second Inversions
 * 
...
export default function ExtendedLevel3Page() {
          ...
          <div className="flex flex-col xl:flex-row gap-8 items-start justify-center min-h-[80vh]">
            ...
            <div className="text-center bg-white/20 backdrop-blur-sm rounded-2xl p-8 xl:w-1/3">
              ...
              <div className="text-lg text-black/80 mb-8 space-y-2">
                ...
                <p>Root, first, and second inversions</p>
            ...
            {/* 7th Chord Inversions Legend (Root, 1st, 2nd) */}
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 xl:w-2/3 max-h-[80vh] overflow-y-auto">
              <h3 className="text-2xl font-bold text-black mb-6 text-center">7th Chords - Root, 1st & 2nd Inversions</h3>
              
              {/* Major 7th Example */}
              <div className="mb-6">
                <h4 className="text-lg font-bold text-black mb-3 text-center">Major 7th (Cmaj7)</h4>
                <div className="grid grid-cols-3 lg:grid-cols-3 gap-3 max-w-2xl mx-auto">
                  {[
                    ...
                    return (
                      <div key={i} className="bg-white/30 rounded-lg p-2">
                        ...
                        <div className="flex justify-center mb-1">
                          <div className="bg-white rounded shadow-lg overflow-hidden" style={{ width: '120px', height: `${Math.max(80, totalSemitones * 6)}px` }}>
                                ...
                                {chord.midiNotes.map((midiNote, j) => {
                                  ...
                                  return (
                                    <div key={j} className={`absolute rounded shadow-lg ${isCNote ? 'bg-red-500' : 'bg-blue-500'}`} 
                                         style={{ left: '2px', top: `${position + 1}px`, width: '80px', height: '4px' }}></div>
                                  );
                                })}
                              </div>
                            </div>
                        ...
                        <p className="text-xs text-black/70 text-center" style={{ fontSize: '10px' }}>{chord.notation}</p>
                      </div>
                    );
                  })}
                </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F9D6E8] to-[#D8D6F9] flex items-center justify-center p-6">
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 max-w-md w-full text-center">
          ...
          <div className="space-y-4">
            {levelResult.passed && (
              <Link 
                to="/chord-recognition/extended-chords/recognition/level4"
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <div className="mt-6 text-center mb-8">
          ...
          <p className="text-black/70 mb-6">
            Type the 7th chord name with inversion (e.g., Cmaj7, Dm7/1, Dm7/F, G7/2, G7/D, Cm7♭5/1)
          </p>
        </div>
