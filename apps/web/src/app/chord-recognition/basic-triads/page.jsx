      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-12">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-white mb-2">Chord Recognition</h3>
            <p className="text-white/70">Listen to chords and identify what you hear</p>
          </div>
        ...
        <div className="mb-12">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-white mb-2">Chord Construction</h3>
            <p className="text-white/70">Build chords by placing notes on the piano roll</p>
          </div>
