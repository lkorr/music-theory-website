...
export const noteNames: readonly string[] = ['C', 'C#', 'D', 'D#', 'E', 'F', 'F#', 'G', 'G#', 'A', 'A#', 'B'];

// Alternative note names with enharmonic equivalents
export const noteNamesWithEnharmonics: readonly string[] = [
  'C',
  'C# / Db',
  'D',
  'D# / Eb',
 ...
 * @param midiNote - MIDI note number (0-127)
 * @returns Note name with enharmonics and octave (e.g., 'C# / Db 4')
 */
 ...
 */
export const getNaturalNotes = (): readonly string[] => {
